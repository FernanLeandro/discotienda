...
<body>
    <form action="proveedor/op_actualizar.php" method="POST">
        <input type="hidden" name="proveedorID" value="<?php echo $proveedor->getProveedorID(); ?>">
        <div>
            <label for="nombre">Nombre Proveedor</label>
            <input type="text" name="nombre_proveedor" id="nombre_proveedor" class="dato_formulario" required maxlength="200" value="<?php echo $proveedor->getNombreProveedor(); ?>">
        </div>
        <div>
            <label for="nacionalidad">Contacto</label>
            <input type="text" name="contacto" id="contacto" class="dato_formulario" required value="<?php echo $proveedor->getContacto(); ?>">
        </div>
        <div>
            <label for="nacionalidad">Teléfono</label>
            <input type="text" name="telefono" id="telefono" class="dato_formulario" required value="<?php echo $proveedor->getTelefono(); ?>">
        </div>
        <div>
            <label for="nacionalidad">Email</label>
            <input type="text" name="email" id="email" class="dato_formulario" required value="<?php echo $proveedor->getEmail(); ?>">
        </div>
